...
public class Transfer extends AppCompatActivity {
    ...
    List<Customer> transferTo = new ArrayList<>();
    RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;
    CustomerTransAdapter adapter;
    ...
    private void showData(String phonenumber) {
        ...
        while(cursor.moveToNext()){
            ...
            transferTo.add(customer);
        }

        adapter = new CustomerTransAdapter(Transfer.this, transferTo);
        recyclerView.setAdapter(adapter);
    }

    public void selectuser(int position) {
       selectuser_phonenumber = transferTo.get(position).getPhoneno();
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(Transfer.this);
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        new DatabaseHelper(Transfer.this).insertTransferData(date, name, "Not selected", transferamount, "Failed");
                        Toast.makeText(Transfer.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                        startActivity(new Intent(Transfer.this, MainActivity.class));
                        finish();
                    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                for(Customer customer : transferTo){
